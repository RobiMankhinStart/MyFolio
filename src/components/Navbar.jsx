...
const Navbar = () => {
  return (
    <section
      id="navbar"
      className="hidden lg:inline-block fixed left-0 right-0 z-20  bg-[#1c1a1fbb] p-3 border border-b-white"
    >
      <div className="container">
        <div className="containerRow flex items-center justify-between">
          ...
          <div className="navOptions ">
            <div className="flex items-center justify-center gap-7 font-funnel text-[20px] text-white font-semibold">
              <a
                href="#banner"
          ...
          <div className="socials">
            <div className="flex justify-around gap-4 items-center px-4 py-[2px] bg-black rounded-[15px] ring-1 ring-white">
              <a
              ...
              >
                ...
                <div className="absolute top-11 left-1/2 transform -translate-x-1/2 mb-4 w-max px-2 py-1 text-white bg-black rounded-md opacity-0 scale-50 transition-all duration-500 group-hover:opacity-100 group-hover:scale-100">
                  Github
                </div>
              </a>
              {/* <div className="relative group hover:cursor-pointer hover:bg-slate-800 p-2 rounded-full transition-all duration-500">
                <SiGmail classNameName="text-white text-xl" />
              ...
              >
                ...
                <div className="absolute top-11 left-1/2 -translate-x-1/2 mb-4 w-max px-2 py-1 text-white bg-black rounded-md opacity-0 transform scale-50 transition-all duration-500 group-hover:opacity-100 group-hover:scale-100">
                  Facebook
                </div>
              </a>
